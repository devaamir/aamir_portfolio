  ...
  const projects = [
    {
      ...
      description: 'Medicine delivery across Canada with trusted pharmacies, temperature-controlled shipping, real-time tracking, and 24/7 support for essential medications.',
    ...
    {
      title: 'One Way',
      description: 'Connecting senders with available transport space to reduce waste, lower costs, and minimize environmental impact of land transportation.',
    ...
    {
      title: 'Can Support',
      description: 'Compassionate platform for cancer patients and caregivers offering psychosocial support, transportation, housing, financial aid, and counseling.',
    ...
    },
    {
      ...
      github: 'https://github.com/sayedaamir/3d-football',
          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="relative overflow-hidden">
                <div className="w-full h-48 bg-gradient-to-br from-dark-accent/20 to-dark-purple/20 flex items-center justify-center">
                  {project.image.startsWith('/api/placeholder') ? (
                    <div className="text-4xl font-bold text-dark-accent opacity-50">
                ...
                <div className="absolute inset-0 bg-dark-bg/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center space-x-2">
                  ...
                  {project.appStore && (
                    <Button variant="secondary" size="sm" href={project.appStore}>
                      <ExternalLink size={16} className="mr-1" />
                      App Store
                    </Button>
                  )}
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2 group-hover:text-dark-accent transition-colors duration-300">
                  {project.title}
                </h3>
                ...
                <div className="flex flex-wrap gap-2">
                  {project.tech.map((tech) => (
                    <span
                      key={tech}
                      className="px-3 py-1 bg-dark-accent/10 text-dark-accent text-sm rounded-full border border-dark-accent/30"
                    >
                      {tech}
                    </span>
                  ))}
